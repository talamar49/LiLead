...
abstract class AppLocalizations {
  ...
  /// No description provided for @leadManagement.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @wonLeads.
  ///
  /// In en, this message translates to:
  /// **'Won Leads'**
  String get wonLeads;
  ...
  /// No description provided for @statusNotRelevant.
  ///
  /// In en, this message translates to:
  /// **'Not Relevant'**
  String get statusNotRelevant;
  ...
  /// No description provided for @sourceWebhook.
  ///
  /// In en, this message translates to:
  /// **'Webhook'**
  String get sourceWebhook;
